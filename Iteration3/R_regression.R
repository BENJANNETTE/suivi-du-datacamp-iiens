...
# Logistic Selection de variables
summary(RegLG)
...
write.table(Sub_RLogit2, file="../suivi-du-datacamp-iiens/Submission/Submission_R_Logistic2.csv", 
            row.names = F, quote=F, sep=",")
...
spark_read_csv(sc, "df_hist1", path_histo1, header = TRUE, delimiter = ",")
df_merch = spark_read_csv(sc, "df_merch", path_merch, header = TRUE, delimiter = ",")
spark_read_csv(sc, "df_new_merch", path_new_merch, header = TRUE, delimiter = ",")
